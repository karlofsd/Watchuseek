                ...
                <form onSubmit={(e) => handleSubmit(e)} >
                    <div >
                        <div>
                            <label>Nombre</label>
                            <br />
                            <input  className = "input" type="text" name="name"  placeholder='ingresar nombre' value={usuario.name} disabled={!update} />
                        </div>
                        <div className='descripcion'>
                            <label>Username</label><br />
                            <input className = "input" type="text" name="username"  value={usuario.username} disabled={!update}/>
                        </div>
                        <div className='Precio' >
                            <label>Email</label><br />
                            <input className = "input" type="text" name="email"  value={usuario.email} disabled={!update} />
                        </div>
