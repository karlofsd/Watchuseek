            ...
            <div className='left-nav'>
                ...
                <div className="login">
                    ...
                    >
                        ...
                        {
                            !user.isAdmin ?
                                <MenuItem onClick={handleCloser} ><Link onClick={() => dispatch(getOrdersUser(user))} className='itemList' to='/user'>Panel</Link></MenuItem>
                                :
                                <MenuItem onClick={handleCloser} ><Link className='itemList' to='/admin' >Admin</Link></MenuItem>
                        }
