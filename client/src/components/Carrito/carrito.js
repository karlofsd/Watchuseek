                    ...
                    return (
                        <tbody>
                            <tr>
                                <td>{p.name}</td>
                                <td>{p.price}</td>
                                <td>{products.find(product => product.name === p.name.toLowerCase()).stock}</td>
                                <td><input className="inputItem" placeholder='1' type="number" value = {p.quantity} min='1' max={products.find(product => product.name === p.name.toLowerCase()).stock} name={p.quantity} onChange={(e) => handleInputChange(e, index, p)} /></td>
