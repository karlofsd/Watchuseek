        ...
        <div className='cart-content'>
            ...
            {product[0] && <table class="table table-striped table-dark">
                ...
                {product && product.map((p, index) => {
                    ...
                    <td><button type="button" class="btn btn-danger" onClick={() => eliminar(p, index)}>{<DeleteIcon/>}</button></td>
                            </tr>
                        </tbody>
                    )
                })}
            ...
            <div className="contentCarrito">
                {product[0] &&  <div className='divcompras' >
                    <div className='botonescomprar1'  >
                        <button type="button" name='checkout' class="btn btn-success" onClick={()=>checkout()}  >BUY</button><br />
                    </div>
                    <div className='botonescomprar' >
                        <button type="button" class="btn btn-danger" onClick={() => eliminarTodo()} >DISCARD </button>
                    </div>
                </div>}    
            </div>
            </div>
